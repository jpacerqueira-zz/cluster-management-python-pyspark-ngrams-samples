ADD JAR hdfs:///user/analyticsdb/H2O/UDFtest/DLAvgBitRateM18Lib/v5.0/h2o-genmodel.jar;
ADD JAR hdfs:///user/analyticsdb/H2O/UDFtest/DLAvgBitRateM18Lib/v5.0/ScoreDataUDFGBMAVGMUEX-1.0-SNAPSHOT.jar;
...
CREATE TABLE conviva_avgbitrate_1asset_pred AS SELECT asset, deviceos, country, state, city, asn, isp, starttimeunixtime,startuptimems, playingtimems, bufferingtimems, interrupts, startuperror, sessiontags, ipaddress, cdn, browser, convivasessionid, streamurl, errorlist, percentagecomplete, averagebitratekbps,
 scoredata(asn, starttimeunixtime, startuptimems, playingtimems, bufferingtimems, interrupts, startuperror, percentagecomplete) 
